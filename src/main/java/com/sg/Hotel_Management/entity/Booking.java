...
public class Booking {
    ...
    public void setNumOfAdults(@Min(value = 1, message = "Number of Adults must not be less then 1") int numOfAdults) {
    ...
    public @NotNull(message = "Check out date must be in the future") LocalDate getCheckOutDate() {
        return checkOutDate;
    }

    public void setCheckOutDate(@NotNull(message = "Check out date must be in the future") LocalDate checkOutDate) {
